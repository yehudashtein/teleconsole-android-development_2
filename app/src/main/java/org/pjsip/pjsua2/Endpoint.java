...
public class Endpoint {
  ...
  protected void finalize() {
    ...
    Utils.logToFile("Finalizing Endpoint ptr " + swigCPtr + " owned " + swigCMemOwn);
    if (swigCPtr != 0 && swigCMemOwn) {
      SipService.getInstance().enqueueJob(this::delete, "finalizing PJSIP");
    }
//    delete();
  }
  ...
  public int transportCreate(int type, TransportConfig cfg) throws Exception {
