...
//    Utils.logToFile("Finalize account reached ptr " + swigCPtr + " owned? " + swigCMemOwn);
//    boolean isNull = SipService.getInstance().isAccountNull();
//    if (swigCPtr != 0 && swigCMemOwn) {
//      SipService.getInstance().enqueueJob(this::delete, "Finalizing Account " + isNull);
//    }
  }
  ...
  public AccountInfo getInfo() throws Exception {
    if (!SipService.isThreadRegistered() || !swigCMemOwn){
      throw new Exception("PJSUA Exception");
    }
