...
public class Call {
  ...
  protected void finalize() {
    Utils.logToFile("Finalize call reached " + swigCPtr + " owned " + swigCMemOwn);
    if (swigCPtr != 0 && swigCMemOwn) {
      SipService.getInstance().enqueueJob(() -> delete(), "finalizing Account for GC");
    }
  }
  ...
  public CallInfo getInfo() throws Exception {
    if (!SipService.isThreadRegistered() || !swigCMemOwn){
      Exception exception =  new Exception("Thread is not registered");
  ...
  public boolean isActive() {
    ...
    android.util.Log.d("SEG", "is Active " + swigCMemOwn);
    if (!SipService.isThreadRegistered() || !swigCMemOwn){
      return false;
    }
  ...
  public int getId() {
    ...
    android.util.Log.d("SEG", "getID " + swigCMemOwn);
    if (swigCMemOwn) {
      return pjsua2JNI.Call_getId(swigCPtr, this);
    }
    return NonExistentCall.getInstance().getID();
  }
  ...
  public void answer(CallOpParam prm) throws java.lang.Exception {
    if (swigCMemOwn) {
      ...
      throw new Exception("Answer failed memory not owned");
    }
  }

  public void hangup(CallOpParam prm) throws java.lang.Exception {
    if (!swigCMemOwn){
      throw new Exception("Hangup failed memory not owned");
    }
  ...
  public void setHold(CallOpParam prm) throws java.lang.Exception {
    if (!swigCMemOwn){
      throw new Exception("Hold Failed memory not owned");
    }
