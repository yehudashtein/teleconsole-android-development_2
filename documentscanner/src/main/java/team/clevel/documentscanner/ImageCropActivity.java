...
//        btnImageCrop.setBackgroundColor(Color.parseColor(ScannerConstants.cropColor));
    ...
    private void initializeCropping() {
        ...
        try {
            ...
            android.util.Log.d("Polygons", pointFs.toString());
    ...
    private View.OnClickListener btnImageEnhanceClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            android.util.Log.d("Scan02", "Crop Clicked");
            Observable.fromCallable(() -> {
                android.util.Log.d("Scan02", "From Callable");
                ScannerConstants.selectedImageBitmap = getCroppedImage();
                if (ScannerConstants.selectedImageBitmap ==null){
                    android.util.Log.d("Scan02", "no selected image");
                    return false;}
                ...
                return false;
                    ...
                    .subscribe((result) -> {
                        ...
                        android.util.Log.d("Scan02", "Subscribe started");
                        setProgressBar(false);
                        if (ScannerConstants.selectedImageBitmap !=null)
                        {
                            android.util.Log.d("Scan02", "selected image");
